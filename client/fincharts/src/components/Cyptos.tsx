							...
							<div className='relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12'>
								<div className='flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2'>
									<div className='flex flex-shrink-0 items-center'>
										<a href='#'>
											<img className='block h-8 w-auto' src='' alt='' />
										</a>
									</div>
								</div>
										...
										<div className='w-full'>
											...
											<div className='relative'>
												<div className='pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3'>
													<MagnifyingGlassIcon
														className='h-5 w-5 text-white text-lg'
														aria-hidden='true'
													/>
												</div>
												<input
													id='search'
													name='search'
													className='block w-full rounded-md border border-gray-300 bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r py-4 text-xl pl-10 pr-3  placeholder-gray-500 focus:border-indigo-500 focus:text-white focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm'
													placeholder='Search'
													type='search'
												/>
											</div>
